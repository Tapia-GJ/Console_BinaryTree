...
namespace EvaluacionEstrucAvanzada
{
    public class Services
    {
        ...
        public void menu()
        {
            ...
            {
                case 1:
                    Agregar(); Console.Clear();
                    Console.WriteLine("Agregado Correctamente!!!!!");
                    menu();
                    break;
                case 2:
                    Eliminar(); Console.Clear();
        ...
        public void datos()
        {
            ...
            DateTime fecha = new DateTime(1925, 04, 10);
            arbol.Insertar(fecha, nombre);
        ...
        {
            Console.WriteLine("Ingresa la fecha del libro a editar");
            DateTime fecha = ValidarFecha();
            if (arbol.ValidaExistencia(fecha))
            {
                Console.WriteLine("Ingresa el nuevo nombre");
                string nuevoNombre = Console.ReadLine();
                arbol.Editar(fecha, nuevoNombre);
            }else
            {
